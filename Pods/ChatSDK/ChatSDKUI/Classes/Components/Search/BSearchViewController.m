...
- (void)viewDidLoad {
    ...
    if (version.majorVersion < 13) {
        ...
        self.navigationItem.rightBarButtonItem= [[UIBarButtonItem alloc] initWithTitle:[NSBundle t:bBack] style:UIBarButtonItemStylePlain target:self action:@selector(closeButtonPressed)];
    }
    ...
    _closeButton = [[UIBarButtonItem alloc] initWithTitle:[NSBundle t:bClose] style:UIBarButtonItemStylePlain target:self action:@selector(closeButtonPressed)];
    [_closeButton setImage:[UIImage imageNamed:@"Group 97"]];
