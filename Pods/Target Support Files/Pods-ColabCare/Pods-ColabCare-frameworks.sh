...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ChatK!t/ChatKit.framework"
  ...
  install_framework "${PODS_ROOT}/../ChatSDKPro/Licensing/Licensing.framework"
  install_framework "${PODS_ROOT}/../ChatSDKPro/EncryptionModule/VirgilCrypto.framework"
  install_framework "${PODS_ROOT}/../ChatSDKPro/EncryptionModule/VirgilCryptoAPI.framework"
  install_framework "${PODS_ROOT}/../ChatSDKPro/EncryptionModule/VirgilCryptoApiImpl.framework"
  install_framework "${PODS_ROOT}/../ChatSDKPro/EncryptionModule/VSCCrypto.framework"
  install_framework "${PODS_ROOT}/../ChatSDKPro/EncryptionModule/VirgilSDK.framework"
  install_framework "${PODS_ROOT}/../ChatSDKPro/FirebaseModules/FirebaseModules.framework"
  install_framework "${PODS_ROOT}/../ChatSDKPro/FirebaseNearbyUsersModule/FirebaseNearbyUsersModule.framework"
  install_framework "${PODS_ROOT}/../ChatSDKPro/MessageModules/MessageModules.framework"
